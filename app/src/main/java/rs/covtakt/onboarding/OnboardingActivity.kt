...
class OnboardingActivity : FragmentActivity(),
        ...
        SetupBluetoothFragment.OnFragmentInteractionListener,
        SetupLocationFragment.OnFragmentInteractionListener,
        SetupBatteryFragment.OnFragmentInteractionListener,
        SetupCompleteFragment.OnFragmentInteractionListener,

        TOUFragment.OnFragmentInteractionListener {

    private var isFirebaseLogin: Boolean = false
...
//                    alertDialog(getString(R.string.verification_failed))
    ...
    internal fun getTemporaryID(): Task<HttpsCallableResult> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        isFirebaseLogin = intent.getBooleanExtra("firebaseLogin", false)
...
//                Utils.keepServicesInChineseDevices(this)
    ...
    private inner class ScreenSlidePagerAdapter(fm: FragmentManager) :
        ...
        private fun createFragAtIndex(index: Int): OnboardingFragmentInterface {
            return when (index) {
                // 0 -> return  if(isFirebaseLogin) TOUFragment() else RegisterNumberFragment()
                0->return TOUFragment()
                1 -> return SetupFragment()
                2-> return SetupBluetoothFragment()
...
//                }
    ...
    fun showLoading(){
        onboardingActivityLoadingProgressBarFrame.post{
            onboardingActivityLoadingProgressBarFrame.visibility = View.VISIBLE
        }
    }
    fun hideLoading(){
