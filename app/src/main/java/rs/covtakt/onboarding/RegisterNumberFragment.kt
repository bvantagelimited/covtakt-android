...
import kotlinx.android.synthetic.main.fragment_register_number.view.*
...
class RegisterNumberFragment : OnboardingFragmentInterface() {
    ...
    override fun getButtonText(): String = context?.getString(R.string.get_otp)!!
    ...
    private fun requestOTP() {
        mView?.let { view ->
            ...
            Preference.putCountryCode(TracerApp.AppContext!!, country_code.selectedCountryNameCode)
