...
import rs.covtakt.bluetooth.BLEAdvertiser
import rs.covtakt.bluetooth.gatt.ACTION_RECEIVED_STATUS
import rs.covtakt.bluetooth.gatt.ACTION_RECEIVED_STREETPASS
import rs.covtakt.bluetooth.gatt.STATUS
import rs.covtakt.bluetooth.gatt.STREET_PASS
import rs.covtakt.idmanager.TempIDManager
import rs.covtakt.idmanager.TemporaryID
import rs.covtakt.logging.CentralLog
import rs.covtakt.notifications.NotificationTemplates
import rs.covtakt.permissions.RequestFileWritePermission
...
import rs.covtakt.streetpass.StreetPassScanner
import rs.covtakt.streetpass.StreetPassServer
import rs.covtakt.streetpass.StreetPassWorker
...
//            Utils.startBluetoothMonitoringService(applicationContext)
    ...
    private fun setupService() {
        streetPassServer = streetPassServer ?: StreetPassServer(this.applicationContext, serviceUUID)
        setupScanner()
        setupAdvertiser()
    }
